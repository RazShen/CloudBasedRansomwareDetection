...
while True:
    ...
    signatures_to_send = ""
    with open("report.json", 'r') as my_json_report:
        js =my_json_report.read()
        report_dict = json.loads(js)
        signatures_score, matched_signatures = signatures.calculate_signatures_score_and_get_matched_signatures("ransom_signatures_with_severity.json", report_dict)    
